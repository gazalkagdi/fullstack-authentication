                ...
                <div className="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8 ">
                    <div className="text-white">
                        <div className="mb-8 flex flex-col items-center">
                            ...
                            <h1 className="mb-2 text-2xl mt-3">Login Page</h1>
                        ...
                        <form>
                            ...
                            <div className="mt-8 flex justify-center text-lg text-black">
                                <button type="submit" className="rounded-3xl bg-yellow-400 bg-opacity-50 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-600" onClick={handleLogin}>Login</button>
                            </div>
                            <p class="gap-2 text-center text-white mt-5">
                                Don't have an account?
                                <a href="/Register" class="font-semibold text-black hover:text-white">  Sign up</a>
                            </p>
